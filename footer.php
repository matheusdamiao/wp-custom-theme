<footer>
    <img src="<?= get_stylesheet_directory_uri();?>/img/logo-parrillas.svg" alt="Parrillas Beraldo">
    ...
    <small class='footer-copy'> Beraldo Parrillas &copy; <?= date('Y');?> - <?= $complete_address; ?></small>
