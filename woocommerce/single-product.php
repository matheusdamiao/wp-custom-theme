...
?>    
        ...
        <div class='product-detail'>
            ...
            <h2>Descrição</h2>
            <p class='product-descri'><?= $produto['description'];?></p>
        </div>
...
$relacionados_formatados = format_products($related_products, 'medium');
...
<section class='container-separador'>
    <div class='container'>
         ...
         <?php
             homepage_product_list($relacionados_formatados);
          ?>
    </div>
